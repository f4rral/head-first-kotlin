...
fun main(args: Array<String>) {
    ...
    println("mShoppingList set Coffee: $mShoppingList")
    ...
    println("mRecipeMap entries: ${mRecipeMap.entries}")
    println("mRecipeMap keys: ${mRecipeMap.keys}")
    println("mRecipeMap values: ${mRecipeMap.values}")
}